...
```{r}
#| label: fig-power-a
#| fig-cap: "Power Analysis Of Minimally Powered Sample Size"
...
```{r}
#| label: fig-power-b
#| fig-cap: Power Analysis of Under Powered Sample Size
...
```{r} 
#| label: tbl-eda
#| tbl-cap: SUV max Summary Statistics
...
ggplot(plot_dat, aes(x = groups, y = mean)) +
  ...
  labs(x = "Condition", y = "Mean SUV max (± 1 SE)") +
